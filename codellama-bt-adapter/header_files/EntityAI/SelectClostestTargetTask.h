...
//--|
//--| Description:
//--| FSelectClosestTargetTask state tree task.
//--|
//--|====================================================================|--
#pragma once
...
#include "SelectClosestTargetTask.generated.h"

/// @brief Instance data for 'FSelectClosestTargetTask'.
///
/// @ingroup SimulationBehaviors-Module
USTRUCT()
struct SIMULATIONBEHAVIORS_API FSelectClosestTargetTaskInstanceData
{
    GENERATED_BODY()
...
struct SIMULATIONBEHAVIORS_API FSelectClosestTargetTask : public FMilVerseStateTreeTask
{
    GENERATED_BODY()

    /// @brief Alias for this task's instance data type.
    using FInstanceDataType = FSelectClosestTargetTaskInstanceData;
